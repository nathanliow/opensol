...
export const getProgramAccounts: BlockFunctionTemplate = {
  metadata: {
...
export const getProgramAccountsString = `
export const getProgramAccounts = async (params: Record<string, any>) => {
  try {
    const { 
      pubkey,
      network = 'devnet' 
